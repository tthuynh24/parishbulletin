...
# package imports
from ..compat import OrderedDict, zip
...
from ..styles.differential import DifferentialStyle
from ..styles.colors import COLOR_INDEX, Color
from ..styles.style import StyleId
from ..styles.named_styles import NamedStyle
from ..xml.functions import fromstring, safe_iterator, localname
from ..xml.constants import SHEET_MAIN_NS, ARC_STYLE
