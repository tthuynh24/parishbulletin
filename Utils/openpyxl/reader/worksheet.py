...
from ..worksheet.iter_worksheet import IterableWorksheet
from ..worksheet.page import PageMargins, PrintOptions, PageSetup
from ..worksheet.protection import SheetProtection
from ..worksheet.views import SheetView
from ..xml.constants import SHEET_MAIN_NS, REL_NS
from ..xml.functions import safe_iterator
from ..styles import Color
from ..formatting import ConditionalFormatting
from ..worksheet.properties import parse_sheetPr
from ..utils import (
...
class WorkSheetParser(object):
    ...
    def parse_data_validation(self, element):
        from ..worksheet.datavalidation import parser
