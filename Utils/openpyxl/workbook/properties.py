...
from ..compat import safe_string, unicode
from Utils.datetime  import CALENDAR_WINDOWS_1900, datetime_to_W3CDTF, W3CDTF_to_datetime
from ..descriptors import Strict, String, Typed, Alias
from ..xml.functions import ElementTree, Element, SubElement, tostring, fromstring, safe_iterator, localname
from ..xml.constants import COREPROPS_NS, DCORE_NS, XSI_NS, DCTERMS_NS, DCTERMS_PREFIX
